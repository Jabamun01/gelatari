...
exports.createOrUpdateDefaultStepsHandler = exports.getDefaultStepsHandler = void 0;
 ...
 */
const createOrUpdateDefaultStepsHandler = async (req, res) => {
    try {
        const { category } = req.params;
        ...
        const result = await (0, defaultStepsService_1.createOrUpdateDefaultSteps)(category, steps);
        if (result) {
...
exports.createOrUpdateDefaultStepsHandler = createOrUpdateDefaultStepsHandler;

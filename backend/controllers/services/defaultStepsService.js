...
exports.createOrUpdateDefaultSteps = exports.getDefaultStepsByCategory = void 0;
 ...
 */
const createOrUpdateDefaultSteps = async (category, steps) => {
    try {
        const updatedDoc = await DefaultSteps_1.default.findOneAndUpdate({ category }, { steps }, { new: true, upsert: true, runValidators: true } // upsert: create if not found
        ).exec();
        return updatedDoc;
    }
    catch (error) {
...
exports.createOrUpdateDefaultSteps = createOrUpdateDefaultSteps;
